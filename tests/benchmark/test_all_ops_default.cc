...
std::vector<std::vector<int>> shapes_depthwise_conv2d_nchw            = {{2, 32, 112, 112}, {32, 2, 3, 3}};
...
TEST_DEFAULT1(depthwise_conv2d, depthwise_conv2d_nchw, type1, type6, attr_store_depthwise_conv2d)
